---
title: "Create, edit and delete co-curricular posts"
summary: "Create, edit and delete posts in the co-curricular section of your Magic Portfolio."
...
You can create, edit and delete posts by adding, modifying or removing `*.mdx` files in the `src/app/co-curricular/posts` directory.
...
---`,
      language: "tsx",
      label: "src/app/co-curricular/posts/post-1.mdx",
    },
  ]}
/>
